...
public class CharacterTests extends TestCase {
	...
	public void testCharacter(){
		CrabSaveGame csg = null;
		Crab c = new Crab(3, 7, csg);
		int x = c.getXInt();
		int y = c.getYInt();
		c.onTick();
		c.setY(y);
...
//		assertEquals(crab.getHealth(),h-5);
		...
		crab.renderThrownTrash(new Graphics2D(){
		...
		crab.setPowerByTimePressed();
		crab.calculateTrajectory();
		boolean r = crab.isThrowingTrash();
		crab.setScreenPos(67);
		crab.setSpriteNum(34);
		crab.keyPressed(new KeyEvent(new Component(){}, 0, 0, 0, 0){});
		crab.keyReleased(new KeyEvent(new Component(){}, 0, 0, 0, 0){});
	}
	...
	public void testGame3Crab(){
		...
		c.keyPressed(new KeyEvent(new Component(){}, 0, 0, 0, 0){});
		KeyEvent e = new KeyEvent(new Component(){}, 0, 0, 0, 0){};
		c.keyReleased(e);
	}
