...
public class MiscTests extends TestCase{
	...
	public void testArbitraryLine(){
		...
		line.testRender(new Graphics2D() {
	...
	public void testRectBounds(){
		RectBounds rb = new RectBounds(0, 0, 5, 5);
		assertEquals(rb.getX(), 0);
		assertEquals(rb.getY(),0);
		assertEquals(rb.getXLength(),5);
		assertEquals(rb.getYLength(),5);
	...
	public void testTrashCan(){
		...
		TrashCan can2 = new TrashCan(0, 0, 1, 1);
		can.onTick();
		can.render(new Graphics2D() {
		...
		can.renderOverlay(new Graphics2D() {
	...
	public void testGameState(){
		misc.GameState g = misc.GameState.MENU_SCREEN;
		assertEquals(g, GameState.MENU_SCREEN);
		g=GameState.OVERFISHING_GAME_ANIMATION;
		assertEquals(g, GameState.OVERFISHING_GAME_ANIMATION);
		g=GameState.OVERFISHING_GAME;
		assertEquals(g, GameState.OVERFISHING_GAME);
		g=GameState.CRAB_SAVE_GAME_ANIMATION;
		assertEquals(g, GameState.CRAB_SAVE_GAME_ANIMATION);
		g=GameState.CRAB_SAVE_GAME;
		assertEquals(g, GameState.CRAB_SAVE_GAME);
		g=GameState.POLLUTION_GAME_ANIMATION;
		assertEquals(g, GameState.POLLUTION_GAME_ANIMATION);
		g=GameState.POLLUTION_GAME;
		assertEquals(g, GameState.POLLUTION_GAME);
		g=GameState.SHOW_STATS;
		assertEquals(g, GameState.SHOW_STATS);
	}
	
	public void testDialogBox(){
		DialogBox db = new DialogBox(new Game() {
			
			/**
			 * 
			 */
			private static final long serialVersionUID = 2290956511302860628L;
	...
	public void testSoundDoer(){
		SoundDoer sd = new SoundDoer();
		sd.loadClip("/losesound2.wav");
		sd.loadClip("/losesound2.wav");
		sd.playLoadedClip(0);
		sd.fadeOutFast(1);
		sd.setClipVolume(1, 1);
		boolean b = sd.isDone(0);
		sd.stopClip(1);
		sd.stopAllSoundAndReleaseResources();
